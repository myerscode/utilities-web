...
final class AddQueryParamsTest extends BaseUriSuite
{
    public static function dataProvider(): Iterator
    {
        ...
        yield 'override another query by string' => ['https://myerscode.com?hello=world', 'hello=bar', 'https://myerscode.com?hello=world&hello=bar'];
        yield 'override another query by array' => ['https://myerscode.com?hello=world', ['hello' => 'bar'], 'https://myerscode.com?hello=world&hello=bar'];
    }
